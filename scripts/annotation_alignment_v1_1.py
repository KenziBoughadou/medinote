"""Alignement v1.1 : faits facultatifs sourcés admis hors gold.

Copie versionnée du validateur v1 : seule la nécessité d’un gold pour
supported_optional est levée. Aucun fichier du manifest gelé n’est modifié.
La validation de structure ne constitue pas un jugement sémantique.
"""
...
def validate_alignment(annotation, note, gold, case, guide_sha256):
    ...
    for claim in annotation.claims:
        ...
        if (
            claim.label in {"supported_expected", "contradiction"}
