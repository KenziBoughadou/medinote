...
export function formatPercentagePoints(value:number|null|undefined){return value==null?'Non évalué':`${new Intl.NumberFormat('fr-FR',{maximumFractionDigits:1}).format(value*100)} points`}
